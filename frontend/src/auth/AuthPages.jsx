    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="login-copy">
          Choose your account type, then sign in to access your live academic
          workspace.
        </p>
...
export function Signup({ onSignup, onBack }) {
  ...
  const submit = async (event) => {
    ...
    try {
      const { user } = await apiRequest('/api/auth/student-signup/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <div className="login-page">
      <div className="login-card signup-card">
        ...
        <p className="login-copy">
          Register once to access your live academic record. Teacher accounts
          are created by the super admin.
        </p>
